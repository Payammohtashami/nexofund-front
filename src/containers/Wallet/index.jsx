...
const MainWallet = () => {
    ...
    return (
        <div className='container py-36 md:py-56 mx-auto px-2 xl:max-w-screen-xl top-0 md:px-0'>
            <div className='items-stretch grid gap-16 grid-cols-1 md:grid-cols-2'>
